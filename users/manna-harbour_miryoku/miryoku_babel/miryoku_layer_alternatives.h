...
LGUI_T(SE_Q),   LALT_T(SE_S),   LCTL_T(SE_D),   LSFT_T(SE_F),   SE_G,              SE_H,              LSFT_T(SE_J),   LCTL_T(SE_K),   LALT_T(SE_L),   LGUI_T(SE_M),   \
LT(U_BUTTON,SE_W),ALGR_T(SE_X),   SE_C,              SE_V,              SE_B,              SE_N,              SE_COMM,           SE_DOT,            ALGR_T(SE_SLSH),LT(U_BUTTON,SE_ODIA),\
...
LGUI_T(SE_Y),   LALT_T(SE_I),   LCTL_T(SE_E),   LSFT_T(SE_A),   SE_DOT,            SE_D,              LSFT_T(SE_S),   LCTL_T(SE_T),   LALT_T(SE_N),   LGUI_T(SE_B),   \
LT(U_BUTTON,SE_J),ALGR_T(SE_SLSH),SE_COMM,           SE_K,              SE_ODIA,           SE_W,              SE_M,              SE_L,              ALGR_T(SE_P),   LT(U_BUTTON,SE_V),\
U_NP,              U_NP,              LT(U_FUN,KC_DEL),  LT(U_NUM,KC_BSPC), LT(U_SYM,KC_ENT),  LT(U_MOUSE,KC_TAB),LT(U_NAV,KC_SPC),  LT(U_MEDIA,KC_ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK_FLIP \
SE_Q,              SE_W,              SE_F,              SE_P,              SE_G,              SE_J,              SE_L,              SE_U,              SE_Y,              SE_ODIA,           \
LGUI_T(SE_A),   LALT_T(SE_R),   LCTL_T(SE_S),   LSFT_T(SE_T),   SE_D,              SE_H,              LSFT_T(SE_N),   LCTL_T(SE_E),   LALT_T(SE_I),   LGUI_T(SE_O),   \
LT(U_BUTTON,SE_Z),ALGR_T(SE_X),   SE_C,              SE_V,              SE_B,              SE_K,              SE_M,              SE_COMM,           ALGR_T(SE_DOT), LT(U_BUTTON,SE_SLSH),\
U_NP,              U_NP,              LT(U_FUN,KC_DEL),  LT(U_NUM,KC_BSPC), LT(U_SYM,KC_ENT),  LT(U_MOUSE,KC_TAB),LT(U_NAV,KC_SPC),  LT(U_MEDIA,KC_ESC),U_NP,              U_NP
...
LT(U_BUTTON,SE_Z),ALGR_T(SE_X),   SE_C,              SE_D,              SE_V,              SE_K,              SE_H,              SE_COMM,           ALGR_T(SE_DOT), LT(U_BUTTON,SE_SLSH),\
U_NP,              U_NP,              LT(U_FUN,KC_DEL),  LT(U_NUM,KC_BSPC), LT(U_SYM,KC_ENT),  LT(U_MOUSE,KC_TAB),LT(U_NAV,KC_SPC),  LT(U_MEDIA,KC_ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK_FLIP \
SE_Q,              SE_W,              SE_F,              SE_P,              SE_B,              SE_J,              SE_L,              SE_U,              SE_Y,              SE_ODIA,           \
LGUI_T(SE_A),   LALT_T(SE_R),   LCTL_T(SE_S),   LSFT_T(SE_T),   SE_G,              SE_K,              LSFT_T(SE_N),   LCTL_T(SE_E),   LALT_T(SE_I),   LGUI_T(SE_O),   \
LT(U_BUTTON,SE_Z),ALGR_T(SE_X),   SE_C,              SE_D,              SE_V,              SE_M,              SE_H,              SE_COMM,           ALGR_T(SE_DOT), LT(U_BUTTON,SE_SLSH),\
U_NP,              U_NP,              LT(U_FUN,KC_DEL),  LT(U_NUM,KC_BSPC), LT(U_SYM,KC_ENT),  LT(U_MOUSE,KC_TAB),LT(U_NAV,KC_SPC),  LT(U_MEDIA,KC_ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK_FLIP \
SE_ODIA,           SE_COMM,           SE_DOT,            SE_P,              SE_Y,              SE_F,              SE_G,              SE_C,              SE_R,              SE_L,              \
LGUI_T(SE_A),   LALT_T(SE_O),   LCTL_T(SE_E),   LSFT_T(SE_U),   SE_I,              SE_D,              LSFT_T(SE_H),   LCTL_T(SE_T),   LALT_T(SE_N),   LGUI_T(SE_S),   \
LT(U_BUTTON,SE_SLSH),ALGR_T(SE_Q),   SE_J,              SE_K,              SE_X,              SE_B,              SE_M,              SE_W,              ALGR_T(SE_V),   LT(U_BUTTON,SE_Z),\
U_NP,              U_NP,              LT(U_FUN,KC_DEL),  LT(U_NUM,KC_BSPC), LT(U_SYM,KC_ENT),  LT(U_MOUSE,KC_TAB),LT(U_NAV,KC_SPC),  LT(U_MEDIA,KC_ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK_FLIP \
SE_W,              SE_L,              SE_R,              SE_B,              SE_Z,              SE_ODIA,           SE_Q,              SE_U,              SE_D,              SE_J,              \
LGUI_T(SE_S),   LALT_T(SE_H),   LCTL_T(SE_N),   LSFT_T(SE_T),   SE_COMM,           SE_DOT,            LSFT_T(SE_A),   LCTL_T(SE_E),   LALT_T(SE_O),   LGUI_T(SE_I),   \
LT(U_BUTTON,SE_F),ALGR_T(SE_M),   SE_V,              SE_C,              SE_SLSH,           SE_G,              SE_P,              SE_X,              ALGR_T(SE_K),   LT(U_BUTTON,SE_Y),\
U_NP,              U_NP,              LT(U_FUN,KC_DEL),  LT(U_NUM,KC_BSPC), LT(U_SYM,KC_ENT),  LT(U_MOUSE,KC_TAB),LT(U_NAV,KC_SPC),  LT(U_MEDIA,KC_ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN_FLIP \
SE_Q,              SE_D,              SE_R,              SE_W,              SE_B,              SE_J,              SE_F,              SE_U,              SE_P,              SE_ODIA,           \
LGUI_T(SE_A),   LALT_T(SE_S),   LCTL_T(SE_H),   LSFT_T(SE_T),   SE_G,              SE_Y,              LSFT_T(SE_N),   LCTL_T(SE_E),   LALT_T(SE_O),   LGUI_T(SE_I),   \
LT(U_BUTTON,SE_Z),ALGR_T(SE_X),   SE_M,              SE_C,              SE_V,              SE_K,              SE_L,              SE_COMM,           ALGR_T(SE_DOT), LT(U_BUTTON,SE_SLSH),\
U_NP,              U_NP,              LT(U_FUN,KC_DEL),  LT(U_NUM,KC_BSPC), LT(U_SYM,KC_ENT),  LT(U_MOUSE,KC_TAB),LT(U_NAV,KC_SPC),  LT(U_MEDIA,KC_ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP \
SE_Q,              SE_W,              SE_E,              SE_R,              SE_T,              SE_Y,              SE_U,              SE_I,              SE_O,              SE_P,              \
LGUI_T(SE_A),   LALT_T(SE_S),   LCTL_T(SE_D),   LSFT_T(SE_F),   SE_G,              SE_H,              LSFT_T(SE_J),   LCTL_T(SE_K),   LALT_T(SE_L),   LGUI_T(SE_ODIA),\
LT(U_BUTTON,SE_Z),ALGR_T(SE_X),   SE_C,              SE_V,              SE_B,              SE_N,              SE_M,              SE_COMM,           ALGR_T(SE_DOT), LT(U_BUTTON,SE_SLSH),\
U_NP,              U_NP,              LT(U_FUN,KC_DEL),  LT(U_NUM,KC_BSPC), LT(U_SYM,KC_ENT),  LT(U_MOUSE,KC_TAB),LT(U_NAV,KC_SPC),  LT(U_MEDIA,KC_ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ_FLIP \
SE_Q,              SE_W,              SE_E,              SE_R,              SE_T,              SE_Z,              SE_U,              SE_I,              SE_O,              SE_P,              \
LGUI_T(SE_A),   LALT_T(SE_S),   LCTL_T(SE_D),   LSFT_T(SE_F),   SE_G,              SE_H,              LSFT_T(SE_J),   LCTL_T(SE_K),   LALT_T(SE_L),   LGUI_T(SE_ODIA),\
LT(U_BUTTON,SE_Y),ALGR_T(SE_X),   SE_C,              SE_V,              SE_B,              SE_N,              SE_M,              SE_COMM,           ALGR_T(SE_DOT), LT(U_BUTTON,SE_SLSH),\
U_NP,              U_NP,              LT(U_FUN,KC_DEL),  LT(U_NUM,KC_BSPC), LT(U_SYM,KC_ENT),  LT(U_MOUSE,KC_TAB),LT(U_NAV,KC_SPC),  LT(U_MEDIA,KC_ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_AZERTY \
SE_A,              SE_Z,              SE_E,              SE_R,              SE_T,              SE_Y,              SE_U,              SE_I,              SE_O,              SE_P,              \
LSFT_T(SE_Q),   LALT_T(SE_S),   LCTL_T(SE_D),   LGUI_T(SE_F),   SE_G,              SE_H,              LGUI_T(SE_J),   LCTL_T(SE_K),   LALT_T(SE_L),   LSFT_T(SE_M),   \
LT(U_BUTTON,SE_W),ALGR_T(SE_X),   SE_C,              SE_V,              SE_B,              SE_N,              SE_COMM,           SE_DOT,            ALGR_T(SE_SLSH),LT(U_BUTTON,SE_ODIA),\
...
SE_Q,              SE_H,              SE_O,              SE_U,              SE_X,              SE_G,              SE_C,              SE_R,              SE_F,              SE_Z,              \
LSFT_T(SE_Y),   LALT_T(SE_I),   LCTL_T(SE_E),   LGUI_T(SE_A),   SE_DOT,            SE_D,              LGUI_T(SE_S),   LCTL_T(SE_T),   LALT_T(SE_N),   LSFT_T(SE_B),   \
LT(U_BUTTON,SE_J),ALGR_T(SE_SLSH),SE_COMM,           SE_K,              SE_ODIA,           SE_W,              SE_M,              SE_L,              ALGR_T(SE_P),   LT(U_BUTTON,SE_V),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_TAB),  LT(U_MOUSE,KC_SPC),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK \
SE_Q,              SE_W,              SE_F,              SE_P,              SE_G,              SE_J,              SE_L,              SE_U,              SE_Y,              SE_ODIA,           \
LSFT_T(SE_A),   LALT_T(SE_R),   LCTL_T(SE_S),   LGUI_T(SE_T),   SE_D,              SE_H,              LGUI_T(SE_N),   LCTL_T(SE_E),   LALT_T(SE_I),   LSFT_T(SE_O),   \
LT(U_BUTTON,SE_Z),ALGR_T(SE_X),   SE_C,              SE_V,              SE_B,              SE_K,              SE_M,              SE_COMM,           ALGR_T(SE_DOT), LT(U_BUTTON,SE_SLSH),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_TAB),  LT(U_MOUSE,KC_SPC),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH \
SE_Q,              SE_W,              SE_F,              SE_P,              SE_B,              SE_J,              SE_L,              SE_U,              SE_Y,              SE_QUOT,           \
LSFT_T(SE_A),   LALT_T(SE_R),   LCTL_T(SE_S),   LGUI_T(SE_T),   SE_G,              SE_M,              LGUI_T(SE_N),   LCTL_T(SE_E),   LALT_T(SE_I),   LSFT_T(SE_O),   \
LT(U_BUTTON,SE_Z),ALGR_T(SE_X),   SE_C,              SE_D,              SE_V,              SE_K,              SE_H,              SE_COMM,           ALGR_T(SE_DOT), LT(U_BUTTON,SE_SLSH),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_TAB),  LT(U_MOUSE,KC_SPC),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK \
SE_Q,              SE_W,              SE_F,              SE_P,              SE_B,              SE_J,              SE_L,              SE_U,              SE_Y,              SE_ODIA,           \
LSFT_T(SE_A),   LALT_T(SE_R),   LCTL_T(SE_S),   LGUI_T(SE_T),   SE_G,              SE_K,              LGUI_T(SE_N),   LCTL_T(SE_E),   LALT_T(SE_I),   LSFT_T(SE_O),   \
LT(U_BUTTON,SE_Z),ALGR_T(SE_X),   SE_C,              SE_D,              SE_V,              SE_M,              SE_H,              SE_COMM,           ALGR_T(SE_DOT), LT(U_BUTTON,SE_SLSH),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_TAB),  LT(U_MOUSE,KC_SPC),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK \
SE_ODIA,           SE_COMM,           SE_DOT,            SE_P,              SE_Y,              SE_F,              SE_G,              SE_C,              SE_R,              SE_L,              \
LSFT_T(SE_A),   LALT_T(SE_O),   LCTL_T(SE_E),   LGUI_T(SE_U),   SE_I,              SE_D,              LGUI_T(SE_H),   LCTL_T(SE_T),   LALT_T(SE_N),   LSFT_T(SE_S),   \
LT(U_BUTTON,SE_SLSH),ALGR_T(SE_Q),   SE_J,              SE_K,              SE_X,              SE_B,              SE_M,              SE_W,              ALGR_T(SE_V),   LT(U_BUTTON,SE_Z),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_TAB),  LT(U_MOUSE,KC_SPC),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK \
SE_W,              SE_L,              SE_R,              SE_B,              SE_Z,              SE_ODIA,           SE_Q,              SE_U,              SE_D,              SE_J,              \
LSFT_T(SE_S),   LALT_T(SE_H),   LCTL_T(SE_N),   LGUI_T(SE_T),   SE_COMM,           SE_DOT,            LGUI_T(SE_A),   LCTL_T(SE_E),   LALT_T(SE_O),   LSFT_T(SE_I),   \
LT(U_BUTTON,SE_F),ALGR_T(SE_M),   SE_V,              SE_C,              SE_SLSH,           SE_G,              SE_P,              SE_X,              ALGR_T(SE_K),   LT(U_BUTTON,SE_Y),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_TAB),  LT(U_MOUSE,KC_SPC),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN \
SE_Q,              SE_D,              SE_R,              SE_W,              SE_B,              SE_J,              SE_F,              SE_U,              SE_P,              SE_ODIA,           \
LSFT_T(SE_A),   LALT_T(SE_S),   LCTL_T(SE_H),   LGUI_T(SE_T),   SE_G,              SE_Y,              LGUI_T(SE_N),   LCTL_T(SE_E),   LALT_T(SE_O),   LSFT_T(SE_I),   \
LT(U_BUTTON,SE_Z),ALGR_T(SE_X),   SE_M,              SE_C,              SE_V,              SE_K,              SE_L,              SE_COMM,           ALGR_T(SE_DOT), LT(U_BUTTON,SE_SLSH),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_TAB),  LT(U_MOUSE,KC_SPC),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY \
SE_Q,              SE_W,              SE_E,              SE_R,              SE_T,              SE_Y,              SE_U,              SE_I,              SE_O,              SE_P,              \
LSFT_T(SE_A),   LALT_T(SE_S),   LCTL_T(SE_D),   LGUI_T(SE_F),   SE_G,              SE_H,              LGUI_T(SE_J),   LCTL_T(SE_K),   LALT_T(SE_L),   LSFT_T(SE_ODIA),\
LT(U_BUTTON,SE_Z),ALGR_T(SE_X),   SE_C,              SE_V,              SE_B,              SE_N,              SE_M,              SE_COMM,           ALGR_T(SE_DOT), LT(U_BUTTON,KC_PSLS),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_TAB),  LT(U_MOUSE,KC_SPC),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP
...
KC_LSFT,           KC_LALT,           KC_LCTL,           KC_LGUI,           U_NA,              CW_TOGG,           KC_LEFT,           KC_DOWN,           KC_RGHT,           KC_PGDN,           \
U_NA,              KC_ALGR,           TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_ENT,            KC_BSPC,           KC_DEL,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV_VI \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_LSFT,           KC_LALT,           KC_LCTL,           KC_LGUI,           U_NA,              KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           CW_TOGG,           \
U_NA,              KC_ALGR,           TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    U_NA,              KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            KC_INS,            \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_ENT,            KC_BSPC,           KC_DEL,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_LSFT,           KC_LALT,           KC_LCTL,           KC_LGUI,           U_NA,              CW_TOGG,           KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           \
...
KC_LSFT,           KC_LALT,           KC_LCTL,           KC_LGUI,           U_NA,              U_NU,              KC_MS_L,           KC_MS_D,           KC_MS_R,           KC_WH_D,           \
U_NA,              KC_ALGR,           TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_BTN2,           KC_BTN1,           KC_BTN3,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE_VI \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_LSFT,           KC_LALT,           KC_LCTL,           KC_LGUI,           U_NA,              KC_MS_L,           KC_MS_D,           KC_MS_U,           KC_MS_R,           U_NU,              \
U_NA,              KC_ALGR,           TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  U_NA,              KC_WH_L,           KC_WH_D,           KC_WH_U,           KC_WH_R,           U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_BTN2,           KC_BTN1,           KC_BTN3,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE \
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_LSFT,           KC_LALT,           KC_LCTL,           KC_LGUI,           U_NA,              U_NU,              KC_MS_L,           KC_MS_D,           KC_MS_U,           KC_MS_R,           \
...
KC_LSFT,           KC_LALT,           KC_LCTL,           KC_LGUI,           U_NA,              U_NU,              KC_MPRV,           KC_VOLD,           KC_MNXT,           RGB_VAI,           \
...
KC_LSFT,           KC_LALT,           KC_LCTL,           KC_LGUI,           U_NA,              KC_MPRV,           KC_VOLD,           KC_VOLU,           KC_MNXT,           U_NU,              \
...
KC_LSFT,           KC_LALT,           KC_LCTL,           KC_LGUI,           U_NA,              U_NU,              KC_MPRV,           KC_VOLD,           KC_VOLU,           KC_MNXT,           \
U_NA,              KC_ALGR,           TD(U_TD_U_FUN),    TD(U_TD_U_MEDIA),  U_NA,              OU_AUTO,           U_NU,              U_NU,              U_NU,              U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_MSTP,           KC_MPLY,           KC_MUTE,           U_NP,              U_NP
...
SE_DQUO,           KC_4,              KC_5,              KC_6,              SE_EQL,            U_NA,              KC_LGUI,           KC_LCTL,           KC_LALT,           KC_LSFT,           \
...
SE_QUOT,           SE_DLR,            SE_PERC,           SE_CIRC,           SE_PLUS,           U_NA,              KC_LGUI,           KC_LCTL,           KC_LALT,           KC_LSFT,           \
...
KC_F11,            KC_F4,             KC_F5,             KC_F6,             KC_SCRL,           U_NA,              KC_LGUI,           KC_LCTL,           KC_LALT,           KC_LSFT,           \
